...
q12_OLS <- train(
 int_rate ~ quartiles_annual_inc  + term  + dti + grade*loan_amnt + verification_2levels + installment_2stages + grades_comb,
 data = lc_clean_2,
 method = 'lm',
  trControl = control10,
  )
...
data.frame(
  ...
  q12_lasso$results$RMSE,
  q12_ridge$results$RMSE
)
```
