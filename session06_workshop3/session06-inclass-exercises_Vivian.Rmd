...
<<<<<<< HEAD:session06_workshop3/session06-inclass-exercises.Rmd
library(gapminder)
...
df_rwanda <- gapminder %>% 
  ...
  geom_line() +
  scale_color_manual(values = my_colours) 
>>>>>>> 8f502fa86b22ef3d33f3bcee31ee60007cd8b701:session06_workshop3/session06-inclass-exercises_Vivian.Rmd
...
=======
  tibble(x = rnorm(50),
         ...
         age = sample(25:50, 50, replace = TRUE))
  }
>>>>>>> 8f502fa86b22ef3d33f3bcee31ee60007cd8b701:session06_workshop3/session06-inclass-exercises_Vivian.Rmd
sim_data()
```
