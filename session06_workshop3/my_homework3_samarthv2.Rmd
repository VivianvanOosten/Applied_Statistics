...
Downloading GDP data published by United nations from 1970-2016, and glimpsing over data.
...
Tidying the data by converting it to a long format. Changing the Indicator Names to shorter and more concise indicators. Plotting GDP data by it's components for Germany, India and United States of America.
...
tidy_GDP_data  <- UN_GDP_data %>% 
  ...
  pivot_longer(cols=4:51, 
   ...
   mutate(GDP_new = GDP/1e9,
     ...
     IndicatorName %in% "Final consumption expenditure"~ "Final consumption expenditure",
     IndicatorName %in%  "Gross capital formation" ~ "Gross capital formation",
     IndicatorName %in% "Exports of goods and services" ~ "Exports",
     IndicatorName %in% "Gross Domestic Product (GDP)" ~ "Gross Domestic Product",
    ))
...
ggplot(tidy_GDP_data_countrywise)+
  ...
  theme_bw()
# interval = case_when(
#     year %in% c(1970:1980) ~ "1970:1980",
#     year %in% c(1981:1990) ~ "1981-1990",
#     year %in% c(1991:2000) ~ "1991-2000",
...
Calculating percentage difference between actual GDP and GDP by components.
