...
> We consider the relationship between physical acitvity and weight. We will create a variable 'physical_3plus' that says whether a high schooler is physically active for at least 3 days a week. See below the number and % of students that are physically active. The count function and the 
