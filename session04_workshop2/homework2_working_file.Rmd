...
and bootstrap simulation to have higher confidence in the results:
...
CO2 per capita emissions and the deployment of renewables over time, faceted by income group. 
